<template>
  <div class="page-resource-blogroll-list">
...
import { deleteBlogroll, toggleBlogrollIsShow } from '@/services';
import { useBlogrollList } from '@/hooks/resource/blogroll';
...
const {
  ...
  handleToggleIsShow
} = useToggleIsShow(toggleBlogrollIsShow, () => {
  handleSearch();
});
