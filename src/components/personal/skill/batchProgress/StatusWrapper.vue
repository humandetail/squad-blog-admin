...
import { personalSkillBatchStatus } from '@/services';
import _ from 'lodash';
import { success } from '@/utils/http';
import { Modal } from 'ant-design-vue';
import { IPersonalSkillBatchStatus } from '@/types/personalSkill';
...
const {
  loading: confirmLoading,
  fetch: submit
} = useRequest<IBaseResponse<null>, [IPersonalSkillBatchStatus]>(personalSkillBatchStatus);
