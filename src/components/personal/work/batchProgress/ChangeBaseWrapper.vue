...
import { getPersonalBases, getPostCategories, personalWorkBatchBase, postBatchCategory } from '@/services';
import _ from 'lodash';
import { IPostBatchCategory } from '@/types/post';
import { success } from '@/utils/http';
import { Modal } from 'ant-design-vue';
import { IPersonalBaseItem } from '@/types/personalBase';
import { IPersonalWorkBatchBase } from '@/types/personalWork';
...
const {
  loading: confirmLoading,
  fetch: submit
} = useRequest<IBaseResponse<null>, [IPersonalWorkBatchBase]>(personalWorkBatchBase);
